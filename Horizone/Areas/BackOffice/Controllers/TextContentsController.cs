...
namespace Horizone.Areas.BackOffice.Controllers
{
    public class TextContentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TextGenre,TextSubGenre,Title,Passage,Parallel,MetricForm,Tune,Bibliography,Cetom")] TextContent textContent)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TextGenre,TextSubGenre,Title,Passage,Parallel,MetricForm,Tune,Bibliography,Cetom")] TextContent textContent)
        {
            if (ModelState.IsValid)
            {
