...
namespace Horizone.Areas.BackOffice.Controllers
{
    public class CasesController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "Id,NameCaseEn,NameCaseFr,NameCaseZh")] Case cases)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,NameCaseEn,NameCaseFr,NameCaseZh")] Case cases)
        {
            if (ModelState.IsValid)
            {
