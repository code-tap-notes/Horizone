...
namespace Horizone.Areas.BackOffice.Controllers
{
    ...
    {       
        ...
        public ActionResult Create([Bind(Include = "Id,PlaceEn,PlaceFr,PlaceZh")] NamePlace namePlace)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,PlaceEn,PlaceFr,PlaceZh")] NamePlace namePlace)
        {
            if (ModelState.IsValid)
            {
