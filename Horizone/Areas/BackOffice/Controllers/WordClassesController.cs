...
namespace Horizone.Areas.BackOffice.Controllers
{
    public class WordClassesController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "Id,ClassEn,ClassFr,ClassZh")] WordClass wordClass)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,ClassEn,ClassFr,ClassZh")] WordClass wordClass)
        {
            if (ModelState.IsValid)
            {
