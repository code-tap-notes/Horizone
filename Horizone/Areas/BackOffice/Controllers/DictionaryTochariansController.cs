    ...
    public class DictionaryTochariansController : BaseController
    {
        ...
        public ActionResult AddNounAdjective(int? id)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                nounAdjective.TochCommon = dictionaryTocharian.TochCommon;
